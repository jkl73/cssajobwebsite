...
<?php
	...
	foreach ($alltutorial as $entry) {
		...
		echo '<p id='.$entry['id'].' class="tutorial_p" style="background-color: rgba(255, 208, 208, 0.47); border-radius: 5px; padding: 5px 8px 5px 8px">'.'<b>Description:</b><br>'.$entry['descriptions'];
		echo '</p>';
